...
class ManageWordsFrame(tk.Frame):
    def __init__(self, master):
        ...
        tk.Label(
            self.frame_add, text="Manage words", font="Verdana 14 bold", fg="black"
        ...
        tk.Button(
            self.frame_actions, width=10, text="Add", command=self.switch_gender
        ).pack(side=tk.LEFT, padx="5")
        tk.Button(
            self.frame_actions, width=10, text="Find", command=self.switch_gender
        ).pack(side=tk.LEFT, padx="5")
        tk.Button(
